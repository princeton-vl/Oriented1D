...
#resume_from = '/path/to/checkpoint/object_detection/output-detection/object_cascade_mask_rcnn_convnext_base_1dpp_patch4_window7_mstrain_480-800_giou_4conv1f_adamw_3x_coco_in1k_seed0/latest.pth'
